...
import {
  normalizeColors,
  setBlackBackgroundWhiteText,
  setBlackBackgroundYellowText,
  setYellowBackgroundBlackText,
} from "../stores/contrast.store";
    ...
    >
      ...
      >
        ...
        <DrawerContent>
          ...
          <DrawerHeader p={"10px 24px"} textAlign={"center"}>
            Rozmiar czcionki:
          </DrawerHeader>
          <DrawerBody>
            <Flex
          ...
          >
            ...
            <Box
              ...
              p={"5px"}
              w={"60px"}
              onClick={() => setBlackBackgroundWhiteText()}
            >
            ...
            <Box
              ...
              p={"5px"}
              w={"60px"}
              onClick={() => setBlackBackgroundYellowText()}
            >
              <Image src={WhiteBlack} />
            </Box>
            <Box
              cursor={"pointer"}
              border={"1px solid black"}
              p={"5px"}
              w={"60px"}
              onClick={() => setYellowBackgroundBlackText()}
            >
              <Image src={YellowBlack} />
            </Box>
          </Flex>
          ...
          <Flex
            ...
            pb={"20px"}
          >
            <Text as={Link} href={"/etr"}><Image src={ETR} w={"60px"} cursor={"pointer"} /></Text>
          </Flex>
        </DrawerContent>
      </Drawer>
    </Box>
